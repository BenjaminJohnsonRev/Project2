...
import com.example.project2.entity.menu.ingredients.Vegetable;
...
public interface VegetableRepository extends JpaRepository<Vegetable, Long> {
    ...
    @Query(value = "SELECT * FROM vegetable where id = ?1", nativeQuery = true)
    public Vegetable findByVegetable_id(Long vegetable_id);
}
